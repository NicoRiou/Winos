...
CREATE TABLE `coffret` (
  ...
  `occasion` char(55) DEFAULT NULL,
  `prix` float DEFAULT NULL,
  `produits` char(200) DEFAULT NULL,
...
LOCK TABLES `coffret` WRITE;
/*!40000 ALTER TABLE `coffret` DISABLE KEYS */;
/*!40000 ALTER TABLE `coffret` ENABLE KEYS */;
UNLOCK TABLES;
